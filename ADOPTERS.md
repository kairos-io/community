...
| Organization | Contact/Person | Project | Description | Status | Incubation |
|--------------|----------------|---------|-------------|--------|------------|
| [IMT Nord Europe](https://imt-nord-europe.fr/en/) | [Jacques Landru](https://github.com/j-landru) | [abcd](https://framagit.org/j-landru/abcd) | Polymorphic OS used for system and network labs in education | Production | |
